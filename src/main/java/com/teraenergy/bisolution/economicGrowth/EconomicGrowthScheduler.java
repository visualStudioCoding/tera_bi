...
// 초    분     시    일    월    요일
    ...
    public void monthlyExchangeRateScheduler() throws Exception {
        ...
        Map<String, Object> dataMap = new HashMap<>();
         ...
         Map<String, String> compareBase = (Map<String, String>) commonService.selectContents(PROGRAM_ID + ".compareBaseRate");
         Map<String, String> compareExchange = (Map<String, String>) commonService.selectContents(PROGRAM_ID + ".compareExchangeRate");
...
//    국가채무현황
    ...
    public void stateDebtScheduler() throws Exception {
        ...
        Map<String, Object> dataMap = new HashMap<>();
        Map<String, String> compareDebt = (Map<String, String>) commonService.selectContents(PROGRAM_ID + ".compareStateDebt");
    ...
    public void gdpAndGniScheduler() throws Exception {
        ...
        Map<String, Object> dataMap = new HashMap<>();
        Map<String, String> compareGDP = (Map<String, String>) commonService.selectContents(PROGRAM_ID + ".compareGDP");
        Map<String, String> compareGDI = (Map<String, String>) commonService.selectContents(PROGRAM_ID + ".compareGDI");
        Map<String, String> compareGNI = (Map<String, String>) commonService.selectContents(PROGRAM_ID + ".compareGNI");
    ...
    public void growthRateScheduler() throws Exception {
        ...
        Map<String, Object> dataMap = new HashMap<>();
        Map<String, String> compareGrowth = (Map<String, String>) commonService.selectContents(PROGRAM_ID + "compareGrowthRate");
    ...
    public void inflationRateScheduler() throws Exception {
        ...
        Map<String, Object> dataMap = new HashMap<>();
        Map<String, String> comparePriceInflation = (Map<String, String>) commonService.selectContents(PROGRAM_ID + ".comparePriceInflation");
        Map<String, String> compareLivingInflation = (Map<String, String>) commonService.selectContents(PROGRAM_ID + ".compareLivingInflation");
        Map<String, String> compareCoreInflation = (Map<String, String>) commonService.selectContents(PROGRAM_ID + ".compareCoreInflation");

        ...
        for (int year = 2013; year < 2022; year++) {
            ...
            for (int month = 1; month <= 12; month++) {
                ...
                for (Object jsonObject : jsonList) {
                    ...
                    String getYear = (String) jsonData.get("PRD_DE");

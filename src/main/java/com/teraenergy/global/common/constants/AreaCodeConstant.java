...
public final class AreaCodeConstant {
    ...
    public static final List<String> OTHER_INCHEON = List.of("23", "0006");
    public static final List<String> OTHER_GWANGJU = List.of("24", "0007");
    public static final List<String> OTHER_DAEJEON = List.of("25", "0008");
    public static final List<String> OTHER_ULSAN = List.of("26", "0009");
    public static final List<String> OTHER_SEJONG = List.of("29", "0019");
    public static final List<String> OTHER_GYEONGGI = List.of("31", "0010");
    public static final List<String> OTHER_GANGWON = List.of("32", "0011");
    public static final List<String> OTHER_CHUNGBUK = List.of("33", "0012");
    public static final List<String> OTHER_CHUNGNAM = List.of("34", "0013");
    public static final List<String> OTHER_JEONBUK = List.of("35", "0014");
    public static final List<String> OTHER_JEONNAM = List.of("36", "0015");
    public static final List<String> OTHER_GYEONGBUK = List.of("37", "0016");
    public static final List<String> OTHER_GYEONGNAM = List.of("38", "0017");
    public static final List<String> OTHER_JEJU = List.of("39", "0018");
}

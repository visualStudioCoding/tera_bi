...
function fnFinStateChartDom(data) {
    ...
    for (let i = 0; i < data.cagr.length; i++) {
        if (i == data.cagr.length) {
            break;
        }
        if (data.cagr[0] == 0) {
            minimum = data.cagr[1]
        ...
        if (minimum > data.cagr[i + 1]) {
            minimum = data.cagr[i + 1];
        }
    }
    ...
    if (finStateChartDom) {
                    ...
                    markPoint: {
                        data: [
                            ...
                            },
                            {
                                // type: "min",
                                name: "Min",
                                coord: [data.cagr.indexOf(minimum), minimum],
                                // symbolRotate: 180,
        ...
        finStateGraphOp.series[9].data = data.cagr;
